...
datapath=/home/dev/xiongjun/video_classification/data/yt8m/frame/train
eval_path=/home/dev/xiongjun/video_classification/data/yt8m/frame/validate
test_path=/home/dev/xiongjun/video_classification/data/yt8m/frame/test
...
python train.py ${parameters} --model=${model_name}  --num_readers=8 --learning_rate_decay_examples 2000000 \
                ...
                --feature_names="rgb,audio" --feature_sizes="1024,128" --batch_size=2 --base_learning_rate=0.0002 \
                --learning_rate_decay=0.8 --l2_penalty=1e-5 --max_step=700000 --num_gpu=1
